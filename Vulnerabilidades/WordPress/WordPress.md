...
desc: Abuso da vulnerabilidade de XXE (XML External Entity) na importação de mídia do WordPress para ler arquivos locais.
tags: cve, vulnerability, wordpress, xxe
readTime: 6 min
-->
