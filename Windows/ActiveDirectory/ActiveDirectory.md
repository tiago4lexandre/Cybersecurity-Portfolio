...
desc: Exploração de redes empresariais governadas por AD: técnicas de Kerberoasting, AS-REP Roasting e Golden Tickets.
tags: windows, active-directory, post-exploitation
readTime: 10 min
-->
