...
desc: Técnicas de escalação de privilégios locais no Windows, cobrindo token manipulation, services vulneráveis e DLL Hijacking.
tags: windows, privesc, post-exploitation
readTime: 9 min
-->
