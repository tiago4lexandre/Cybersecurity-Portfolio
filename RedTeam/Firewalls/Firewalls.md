...
desc: Estudo de técnicas de evasão de Web Application Firewalls (WAF) e firewalls de rede através de fragmentação e codificação.
tags: firewall, evasion, network
readTime: 6 min
-->
